...
public class PatternConcept {
	...
	public static void main(String[] args) {
		...
		pat = Pattern.compile("\\d{2}");// if we want only 2 numbers
		mat = pat.matcher("100000");
		System.out.println("For \\d+:" + mat.matches());

		pat = Pattern.compile("\\d{2,4}");// if we want min number as 2 and max number 4.
		mat = pat.matcher("100000");
		System.out.println("For \\d+:" + mat.matches());
...
//ctrl+shift+f  === proper space
//ctrl+a and ctrl+i == for proper alignment
//project -> clean ==proper arrangement
